/* 
This is the first version of my coursework deadline program. This version
prints the course name, assignment name, and due date ONLY.
*/
...
void parse_file(char *name[], char *assignment[], char *due[]);
void print_results(char *name[], char *assignment[], char *due[], int noOfLines);
...
int main(void) {
	...
	/* Loading in the file */
	parse_file(courseName, assignmentName, dueDate);
	...
	/* Prints Calculations */
	print_results(courseName, assignmentName, dueDate, noOfLines);
